...
author: |
  | Max van Deventer
  | m.f.vandeventer@students.uu.nl
  | http://www.github.com/Maxvdeventer
date: April 2023
urlcolor: purple
linkcolor: purple
output: 
...
This table displays the mean, median, standard deviation, minimum, and maximum values of economic growth and real GDP in 1960 for countries that experienced either 0 revolutions or more than 0 revolutions. Countries with ">0 Revolutions" have a higher mean and median of economic growth (2.46 and 2.29, respectively) compared to those with "0 Revolutions" (1.68 and 1.92, respectively).
...
In model 4, the variable education has a coefficient of 0.564 with a high level of significance (p < 0.001). This implicates that education is an driving factor of economic growth in this model. The positive coefficient indicates that as the level of education increases, economic growth is expected to increase as well.
...
```{r}
list(model1, model2, model3, model4) |>
  modelsummary(stars=T, gof_map = c("nobs", "r.squared"), output = "table_1.docx")
```
